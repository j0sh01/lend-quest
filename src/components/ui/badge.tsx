  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        active: "border-transparent bg-accent text-accent-foreground hover:bg-accent/80",
        completed: "border-transparent bg-muted text-muted-foreground hover:bg-muted/80",
        overdue: "border-transparent bg-destructive text-destructive-foreground hover:bg-destructive/80 animate-pulse",
      },
    },
    defaultVariants: {
      variant: "default",
